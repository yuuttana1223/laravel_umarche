                                ...
                                <form action="{{ route('admin.owners.update', $owner) }}" method="post">
                                    ...
                                    <div class="-m-2">
                                        <div class="p-2 w-1/2 mx-auto">
                                            <label for="name" class="leading-7 text-sm text-gray-600">オーナー名 ※必須</label>
                                        ...
                                        @foreach ($owner->shops as $shop)
                                            <div class="p-2 w-1/2 mx-auto">
                                                <h3 class="leading-7 text-sm text-gray-600">店名</h3>
                                                <p class="text-gray-700 py-1 px-3 leading-8">
                                                    {{ $shop->name }}
                                                </p>
                                            </div>
                                        @endforeach
                                        ...
                                        <div class="p-2 w-1/2 mx-auto">
                                            <label for="password_confirmation"
                                                class="leading-7 text-sm text-gray-600">パスワード確認 ※必須</label>
                                            <input type="password" id="password_confirmation"
                                                name="password_confirmation" required
                                                class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        </div>
                                        <div class="p-2 w-full flex justify-around mt-4">
                                            <a type="button" href="{{ route('admin.owners.index') }}"
